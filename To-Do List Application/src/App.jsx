    ...
    <>
      ...
      <div className="container bg-blue-100 mx-auto my-5 rounded-xl px-4 py-4">
        <div className="addToDo mx-auto">
          ...
          <div className="inputs mx-2 flex justify-center">
            <input
              type="text"
              className="rounded-xl py-3 px-4 my-2 outline-gray-500 w-2/3"
              placeholder="Add your todo here"
              onChange={handleChange}
              value={todo}
            />
            <button
              className="mx-3 text-white font-semibold bg-blue-700 px-7 py-3 rounded-xl hover:bg-blue-500"
              onClick={handleAdd}
            >
              Add
            </button>
